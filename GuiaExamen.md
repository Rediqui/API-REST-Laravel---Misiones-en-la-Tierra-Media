...
GET http://localhost:8000/api/heroes?page=2
...
GET http://localhost:8000/api/heroes/search/query?name_hero=Mixart
GET http://localhost:8000/api/heroes/search/query?race_hero=Elfo
GET http://localhost:8000/api/heroes/search/query?role_hero=Guerrero
GET http://localhost:8000/api/heroes/search/query?name_hero=Rediqui&race_hero=Humano&page=1
...
PATCH http://localhost:8000/api/heroes/1
Content-Type: application/json
...
PUT http://localhost:8000/api/heroes/1/missions/1
Content-Type: application/json
Accept: application/json
...
GET http://localhost:8000/api/missions?page=2
...
GET http://localhost:8000/api/missions/search/query?title_mission=Matar%20a%20Dios
GET http://localhost:8000/api/missions/search/query?description_mission=Mordor
GET http://localhost:8000/api/missions/search/query?difficulty_mission=extreme
GET http://localhost:8000/api/missions/search/query?status_mission=pending
GET http://localhost:8000/api/missions/search/query?title_mission=Destruir&difficulty_mission=extreme&page=1
...
# 5. ACTUALIZAR MISIÓN
PUT http://localhost:8000/api/missions/1
Content-Type: application/json
Accept: application/json
...
PATCH http://localhost:8000/api/missions/1
Content-Type: application/json
...
# 6. ELIMINAR MISIÓN
DELETE http://localhost:8000/api/missions/1

# 7. VER HÉROES DE UNA MISIÓN
GET http://localhost:8000/api/missions/1/heroes
# Respuesta incluye datos del pivote (status, group_name, timestamps, notes)

# 8. ASIGNAR HÉROES A UNA MISIÓN
POST http://localhost:8000/api/missions/1/heroes
Content-Type: application/json
Accept: application/json
...
GET http://localhost:8000/api/missions/1/groups/PolloEquipo
# Nota: Si el nombre del grupo tiene espacios, codifícalos: 
# GET http://localhost:8000/api/missions/1/groups/Equipo%20Alpha
...
PUT http://localhost:8000/api/missions/1/groups/status
Content-Type: application/json
Accept: application/json
...
DELETE http://localhost:8000/api/missions/1/groups/PolloEquipo
...
POST http://localhost:8000/api/heroes/5/missions
{
  "missions": [
...
PUT http://localhost:8000/api/heroes/5/missions/1
{
  "status": "in_progress"
}
...
POST http://localhost:8000/api/missions/10/heroes
{
  "heroes": [
...
GET http://localhost:8000/api/missions/10/heroes

# Paso 4: Actualizar estado individual de cada héroe
PUT http://localhost:8000/api/heroes/1/missions/10
{"status": "in_progress"}

PUT http://localhost:8000/api/heroes/2/missions/10
{"status": "completed"}

PUT http://localhost:8000/api/heroes/3/missions/10
{"status": "completed"}
...
GET http://localhost:8000/api/missions/search/query?difficulty_mission=extreme&status_mission=pending

# Buscar héroes guerreros en la página 2
GET http://localhost:8000/api/heroes/search/query?role_hero=Guerrero&page=2
...
# Respuesta paginada:
{
  "current_page": 1,
  "data": [...],
  "first_page_url": "http://localhost:8000/api/heroes?page=1",
  "from": 1,
  "last_page": 2,
  "last_page_url": "http://localhost:8000/api/heroes?page=2",
  "next_page_url": "http://localhost:8000/api/heroes?page=2",
  "path": "http://localhost:8000/api/heroes",
  "per_page": 10,
  "prev_page_url": null,
  "to": 10,
  "total": 15
